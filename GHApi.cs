...
namespace CrushCrush_Cheat
{
    public class GHApi
    {
        ...
        public static IntPtr GetModuleBaseAddress(Process proc, string modName)
        {
            ...
            {
                if (m.ModuleName != modName) continue;
                addr = m.BaseAddress;
                break;;
            }
            return addr;
        ...
        public static IntPtr GetModuleBaseAddress(int procId, string modName)
        {
            ...
            if (hSnap.ToInt64() != INVALID_HANDLE_VALUE)
            {
                ...
                if (Module32First(hSnap, ref modEntry))
                {
                    do
                    {
                        if (!modEntry.szModule.Equals(modName)) continue;
        ...
        public static IntPtr FindDMAAddy(IntPtr hProc, IntPtr ptr, IEnumerable<int> offsets)
        {
